  ...
  const getESNResolve = async () => {
    ...
    if (ethereum) {
      ...
      if (ens !== null) {
        ...
        setResolveENSname(
          'This address does not have any Ethereum Name Service',
        )
      }
    } else {
    ...
    >
      {currentAccount ? (
        <div>
          ...
          {/* LOOK UP ENS  & GET WALLET ADDRESS */}
          <h2>Ethereum Name Service Lookup</h2>
          ...
          {donateNfts ? (
            ...
            <form className="form" noValidate autoComplete="off">
              ...
              <Button
                ...
                variant="contained"
                color="primary"
                onClick={donateStream ? streamPayment : donateNow}
              >
                donate Now
              </Button>
            </form>
